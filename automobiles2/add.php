...
<html>
<head>
    <title>Nishit Shetty</title>
    <style>
        body { font-family: Arial, sans-serif; margin: 40px;}
        .topbar { display: flex; align-items: center; margin-bottom: 26px;}
        .hello { font-size: 1.12em; margin-right: 14px;}
        .logout-btn {
            padding: 4px 14px;
            background: #337ab7;
            color: #fff;
        ...
        .logout-btn:hover { background: #23527c; }
        .error { color: red; }
        .box {
